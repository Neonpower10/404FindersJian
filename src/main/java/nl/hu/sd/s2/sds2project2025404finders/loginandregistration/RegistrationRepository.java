...
public class RegistrationRepository {
    ...
    static {
        // Create a default admin user when the application starts
        Registration admin = new Registration();
        admin.setRegistrationId(idCounter.getAndIncrement());
        admin.setName("Admin");
        admin.setSurname("PO");
        admin.setEmail("admin@camping.nl");
        admin.setPassword(BCrypt.hashpw("Admin123!", BCrypt.gensalt())); // Hashed admin password
        admin.setVerified(true); // Admin is already verified
