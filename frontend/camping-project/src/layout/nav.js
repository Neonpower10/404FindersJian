    ...
    <div class="nav-right">
      ...
      <div class="profile-wrap">
        ...
        <div class="menu" role="menu" aria-label="Profile menu" style="background: var(--card-bg); color: var(--text)">
          ...
          <a role="menuitem" href="/alerts.html" class="admin-visibility">Alerts</a>
          <a role="menuitem" href="/settings.html">Settings</a>
          <a role="menuitem" href="/breadManagement.html" class="admin-visibility">Bread Management</a>
          <a role="menuitem" href="/designAdminPage.html" class="admin-visibility">Styling</a>
          <a role="menuitem" href="/facilitiesAdmin.html" class="admin-visibility">Facilities</a>
