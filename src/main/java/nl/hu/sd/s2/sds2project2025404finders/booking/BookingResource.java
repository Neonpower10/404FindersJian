...
import nl.hu.sd.s2.sds2project2025404finders.dao.BookingDAO;
import nl.hu.sd.s2.sds2project2025404finders.dao.BookingDaoPostgres;
...
public class BookingResource {
    ...
    public List<Booking> bookings() {
        try {
            BookingDAO bookingDAO = new BookingDaoPostgres(DatabaseConnection.getConnection());
    ...
    public Response deleteBooking(@PathParam("id") int id) {
        try {
            BookingDAO bookingDAO = new BookingDaoPostgres(DatabaseConnection.getConnection());
            boolean deleted = bookingDAO.delete(id);
