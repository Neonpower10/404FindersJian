...
export function mountNavBar(root, { title = 'Camping Platform', logo = '' } = {}) {
    ...
    <nav class="navbar">
      <div class="nav-inner">
        ...
        <div class="nav-right">
          <button class="icon btn-bell" aria-label="Meldingen">🔔</button>

          <div class="profile-wrap">
            <button class="icon btn-profile" aria-expanded="false" aria-haspopup="menu">👤</button>
            <div class="menu" role="menu" aria-label="Profielmenu">
              <a role="menuitem" href="/dashboard.html">Dashboard</a>
              <a role="menuitem" href="/camper.html">Boekingen</a>
              <a role="menuitem" href="/meldingen.html">Meldingen</a>
              <a role="menuitem" href="/instellingen.html">Instellingen</a>
              <hr>
