...
import nl.hu.sd.s2.sds2project2025404finders.dao.ProductDAO;
import nl.hu.sd.s2.sds2project2025404finders.dao.ProductDaoPostgres;
...
public class ProductResource {
    ...
    public List<Product> getAllProducts() {
        try {
            ProductDAO productDAO = new ProductDaoPostgres(DatabaseConnection.getConnection());
