        ...
        .then((b) => {
            container.innerHTML = `
                ...
                <div id="displayMode">
                    ...
                    <p><strong>Standplaats:</strong> ${b.campPlace}</p>
                ...
                <div id="editMode" style="display:none;">
                    ...
                    <label>Standplaats:<input id="campPlaceInput" type="text" value="${b.campPlace}"></label><br>
            ...
            document.getElementById("saveBtn").addEventListener("click", async () => {
                const updatedBooking = {
                    ...
                    campPlace: document.getElementById("campPlaceInput").value,
