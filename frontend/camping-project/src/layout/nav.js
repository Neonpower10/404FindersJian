...
export function mountNavBar(root, options) {
        ...
        '<div class="nav-inner">' +
            '<div class="nav-left">' +
                ...
                '<nav class="desktop-nav">' +
                    ...
                    '<a href="/productRentalList.html" class="desktop-nav-item"><span class="material-symbols-outlined">inventory_2</span> Productverhuur</a>' +
            ...
            '<div class="nav-right">' +
                '<div class="profile-wrap">' +
                    ...
                    '<div class="menu m3-menu">' +
                        ...
                        '<a href="/productenManagement.html" class="m3-menu-item"><span class="material-symbols-outlined">inventory_2</span> Productenbeheer</a>' +
                        '<a href="/reservationsManagement.html" class="m3-menu-item"><span class="material-symbols-outlined">receipt_long</span> Product reserveringenbeheer</a>' +
                        '<a href="/breadManagement.html" class="m3-menu-item"><span class="material-symbols-outlined">bakery_dining</span> Broodbeheer</a>' +
                        '<a href="/adminBreadOrders.html" class="m3-menu-item"><span class="material-symbols-outlined">bakery_dining</span> Brood Bestellingenbeheer</a>' +
    ...
    sidebar.innerHTML = '<div class="sidebar-header">' +
        ...
        '<a href="/productRentalList.html" class="m3-sidebar-item"><span class="material-symbols-outlined">inventory_2</span> Productverhuur</a>' +
