...
public class ThemeResource {
    ...
    private Map<String, Map<String, String>> getDefaultThemes() {
        ...
        themes.put("default", Map.of(
                ...
                "--card-bg", "#ffffff", "--navbar-bg", "#2563eb", "--accent", "#2563eb", "--muted", "#6b7280"
        ));
        themes.put("forest - standard", Map.of(
                "--bg", "#ecfdf5", "--text", "#064e3b",
                "--card-bg", "#ffffff", "--accent", "#059669", "--muted", "#6b7280"
        ));
        themes.put("sunset - standard", Map.of(
                "--bg", "#fff7ed", "--text", "#78350f",
                "--card-bg", "#ffffff", "--accent", "#ea580c", "--muted", "#6b7280"
        ));
        themes.put("midnight - standard", Map.of(
                "--bg", "#0f172a", "--text", "#f8fafc",
                "--card-bg", "#1e293b", "--accent", "#6366f1",
                "--muted", "#94a3b8", "--btn-ghost-text", "#ffffff"
        ));
        themes.put("ocean - standard", Map.of(
                "--bg", "#e0f2fe", "--text", "#082f49",
                "--card-bg", "#ffffff", "--accent", "#0284c7", "--muted", "#6b7280"
        ));
        return themes;
    }
